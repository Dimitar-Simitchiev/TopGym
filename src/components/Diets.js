...
import './Diets.css';
    export default function Diets({
      ...
      useEffect(()=>{
      fetch("https://topgymserver.onrender.com/jsonstore/coments")
     .then(res=>res.json())
     ...
     fetch("https://topgymserver.onrender.com/jsonstore/likes")
        .then(res=>res.json())
        .then(x=>Object.values(x))
        .then(result=>{
          ...
          setLike(result)
            ...
            if(x.username===username&&x.programId===program._id){
              setBooLike(true)
            }
       ...
       fetch("https://topgymserver.onrender.com/jsonstore/likes")
        ...
        if (boollike===false) {
          ...
          fetch("https://topgymserver.onrender.com/jsonstore/likes", {
            ...
            document.getElementById("butn"+program._id).disabled = true;
            navigate('/programs');
    ...
    return(
      ...
      <p className='description'>
       ...
       <button className="like-button" id={"butn"+program._id} onClick={onLike}>Like:{like.map(x=>{
